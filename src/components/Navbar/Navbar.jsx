    ...
    >
      ...
      >
        <div className="z-50 px-4 py-2 md:w-auto w-full flex justify-between">
          ...
          <div className="md:hidden py-5 flex justify-center ml-auto mr-4 items-center self-end gap-x-4">
            ...
            <div className="relative">
              <input type="checkbox" className=" opacity-0 absolute cursor-pointer flex justify-between items-center w-14 h-7 rounded-full p-1 z-10" checked={check} onChange={toggleMode} />
        ...
        <div className="md:flex hidden justify-center items-center gap-x-6 z-50">
          ...
          {/* Light/Dark mode switch */}
          <div className="relative">
            <input type="checkbox" className=" opacity-0 absolute cursor-pointer flex justify-between items-center w-14 h-7 rounded-full z-10 p-1" checked={check} onChange={toggleMode} />
            <label htmlFor="checkbox" className="cursor-pointer flex justify-between items-center w-14 h-7 rounded-full relative p-1 bg-gray-100 border">
              <FaMoon color="f1c40f"/>
              <FaSun color="f39c12"/>
              <span className={`bg-secondary opacity-40 absolute w-6 h-7 right-8  rounded-full transition-transform ${!check?"translate-x-8":"translate-x-0"}`}></span>
