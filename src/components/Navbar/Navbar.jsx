        ...
        <div className="z-50 px-4 py-2 md:w-auto w-full flex justify-between">
          ...
          <div className="md:hidden py-5 flex justify-center ml-auto mr-4 items-center self-end gap-x-4">
            ...
            <div className="relative">
              <input type="checkbox" className="opacity-0 absolute flex justify-between item-center w-14 h-7 rounded-full p-1 z-10 cursor-pointer" checked={check} onChange={toggleMode} />
