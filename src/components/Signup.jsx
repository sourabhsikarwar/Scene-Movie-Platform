        ...
        <div className="w-1/2">
          <div className="flex flex-col items-center justify-center w-full ml-5 h-screen ">
            <div className=" p-5 rounded-lg">
              ...
              <h1 className="text-9xl text-yellow-500 font-bold text-center">
                Welcome to <span className="text-sky-500">Scene !</span>
              </h1>
              <p className="text-xl md:text-3xl text-yellow-500 text-center">
                Your Gateway to Infinite Entertainment
              </p>
            </div>
          </div>
        </div>
        <div className="flex w-1/2 container mx-auto flex flex-wrap items-center md:px-0 px-8 w-[45%] h-[50%] mb-10">
          <div className="border backdrop-blur-sm  text-gray-900  rounded-lg p-8 flex flex-col md:mx-auto w-full my-16" role="form">
            <div>
              <h1 className={`text-gradient ${styles.heading3} mb-4`} aria-labelledby="signup-heading">Sign Up</h1>
              {error && <p className="text-red-500" role="alert" aria-live="assertive">{error}</p>}
              <div className="relative mb-4">
                <label
                  htmlFor="full-name"
                  className="leading-8 text-sm text-white dark:text-white "
                >
                  Full Name
                </label>
                <input
                  ...
                  id="full-name"
                  name="displayName"
                  className={`w-full bg-transparent text-white rounded border ${errors.displayNameError ? "border-red-500" : "border-gray-300"
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  id="email"
                  name="email"
                  className={`w-full text-white bg-transparent rounded border ${errors.emailError ? "border-red-500" : "border-gray-300"
              ...
              <div className="relative mb-4 bg-transparent" >
                ...
                <PhoneInput
                  ...
                  className={`w-full rounded border ${errors.phoneNumberError ? "border-red-500" : "border-gray-300"
                    } focus:border-indigo-500 focus:ring-2 bg-transparent focus:ring-indigo-200 text-base outline-none py-1 text-black leading-8 transition-colors duration-200 ease-in-out`}
                ...
                {errors.phoneNumber && errors.phoneNumberError && (
                  <p className="text-red-500 bg-transparent" id="phone-number-error" role="alert">
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  id="date-of-birth"
                  name="dateOfBirth"
                  className={`w-full text-white bg-transparent rounded border ${errors.dateOfBirthError ? "border-red-500" : "border-gray-300"
                    } focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out`}
                  onChange={handleInputs}
                  onKeyDown={handleKeyDown}
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  id="password"
                  name="password"
                  className={`w-full text-white bg-transparent rounded border ${errors.passwordError ? "border-red-500" : "border-gray-300"
                    } focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out`}
                  onChange={handleInputs}
                  onKeyDown={handleKeyDown}
                  required
              ...
              <button
                className={`${styles.button1} my-2 w-full`}
            ...
            <div className="text-white dark:text-white flex my-4 items-center before:border-t before:flex-1  
            ...
            <div className="flex justify-end mt-5">
              <p className="leading-8 text-sm text-white dark:text-white ">
                ...
                <Link
                  to="/login"
                  className="text-sky-500 dark:text-gradient"
                >
                  Login
                </Link>
              </p>
